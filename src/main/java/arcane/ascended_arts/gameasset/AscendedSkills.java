...
public class AscendedSkills {
    ...
    public static void buildSkillEvent(SkillBuildEvent build) {
        SkillBuildEvent.ModRegistryWorker modRagistry = build.createRegistryWorker(Ascended_arts.MOD_ID);

        WeaponInnateSkill celestial_punishment = modRagistry.build("celestial_punishment", CelestialPunishmentSkill:: new, WeaponInnateSkill.createWeaponInnateBuilder());
