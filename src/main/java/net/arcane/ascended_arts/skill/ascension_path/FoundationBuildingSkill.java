...
public class FoundationBuildingSkill extends AscensionSkill{

    private static final UUID EVENT_UUID = UUID.fromString("2d73fb4d-20e5-4b14-a73f-9f9a70eb93f2");

    protected float regenPercentage;

    public FoundationBuildingSkill(Builder builder) {
        super(builder);
    }

    public static FoundationBuildingSkill.Builder createFoundationBuildingBuilder() {
        return (new Builder())
...
*/
    ...
    public static class Builder extends SkillBuilder<FoundationBuildingSkill> {
