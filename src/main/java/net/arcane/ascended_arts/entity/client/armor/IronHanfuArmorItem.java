...
public class IronHanfuArmorItem extends ArmorItem implements IDyeable {
    ...
    public IronHanfuArmorItem(Type slot, Properties builderIn) {
        super(AscendedMaterials.IRON_HANFU, slot, builderIn.stacksTo(1).durability(slot.getDurability(21))
    ...
    public @Nullable ResourceLocation getArmorTexture(@NotNull ItemStack stack, @NotNull Entity entity,
        ...
        return ResourceLocation.fromNamespaceAndPath(Ascended_arts.MOD_ID, "textures/entity/armored_robes/iron/" + dyeColor.getName() + ".png");
    }
