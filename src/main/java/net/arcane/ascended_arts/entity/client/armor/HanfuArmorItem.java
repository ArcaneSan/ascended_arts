...
public class HanfuArmorItem extends ArmorItem implements IDyeable {
    ...
    public HanfuArmorItem(Type slot, Properties builderIn) {
        super(AscendedMaterials.HANFU_ROBES, slot, builderIn.stacksTo(1).durability(slot.getDurability(21))
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            @Override
            public @NotNull RobeModel getHumanoidArmorModel(@NotNull LivingEntity entity, @NotNull ItemStack itemStack, @NotNull EquipmentSlot armorSlot, @NotNull HumanoidModel _default) {
    ...
    public @Nullable ResourceLocation getArmorTexture(@NotNull ItemStack stack, @NotNull Entity entity,
        ...
        return ResourceLocation.fromNamespaceAndPath(Ascended_arts.MOD_ID, "textures/entity/unarmored_robes/" + dyeColor.getName() + ".png");
    }
