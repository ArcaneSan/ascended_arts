...
public class RoyalHunterArmorModel extends GeoModel<RoyalHunterArmorItem> {
    ...
    public ResourceLocation getModelResource(RoyalHunterArmorItem royalHunterArmorItem) {
        return ResourceLocation.fromNamespaceAndPath(Ascended_arts.MOD_ID, "geo/royal_hunter_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(RoyalHunterArmorItem royalHunterArmorItem) {
        return ResourceLocation.fromNamespaceAndPath(Ascended_arts.MOD_ID, "textures/armor/royal_hunter_armor.png");
    }

    @Override
    public ResourceLocation getAnimationResource(RoyalHunterArmorItem royalHunterArmorItem) {
        return ResourceLocation.fromNamespaceAndPath(Ascended_arts.MOD_ID, "animations/royal_hunter_armor.animation.json");
    }
}
