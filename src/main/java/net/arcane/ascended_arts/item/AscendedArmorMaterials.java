...
public enum AscendedArmorMaterials implements ArmorMaterial {
    Mythos("mythos", 45, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 40, SoundEvents.ARMOR_EQUIP_NETHERITE, 5.0F, 0.2F, () -> {
    ...
    private static final EnumMap<ArmorItem.Type, Integer> HEALTH_FUNCTION_FOR_TYPE = Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266653_) -> {
        ...
        p_266653_.put(ArmorItem.Type.LEGGINGS, 16);
        p_266653_.put(ArmorItem.Type.CHESTPLATE, 17);
        p_266653_.put(ArmorItem.Type.HELMET, 12);
    });
    ...
    private AscendedArmorMaterials(String p_268171_, int p_268303_, EnumMap<ArmorItem.Type, Integer> p_267941_, int p_268086_, SoundEvent p_268145_, float p_268058_, float p_268180_, Supplier<Ingredient> p_268256_) {
        this.name = p_268171_;
