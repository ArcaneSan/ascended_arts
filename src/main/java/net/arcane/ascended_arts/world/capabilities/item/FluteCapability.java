...
public class FluteCapability extends CapabilityItem {
    protected FluteCapability(CapabilityItem.Builder builder) {
        super(builder);
    }

    public static CapabilityItem.Builder builder() {
        return CapabilityItem.builder().constructor(FluteCapability::new);
    }
    ...
    public Map<LivingMotion, AnimationManager.AnimationAccessor<? extends StaticAnimation>> getLivingMotionModifier(LivingEntityPatch<?> playerpatch, InteractionHand hand) {
        Map<LivingMotion, AnimationManager.AnimationAccessor<? extends StaticAnimation>> livingModifier = super.getLivingMotionModifier(playerpatch, hand);
        AnimationManager.AnimationAccessor<? extends StaticAnimation> holdAnimation;
        AnimationManager.AnimationAccessor<? extends StaticAnimation> holdMoveAnimation;
